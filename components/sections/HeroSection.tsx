...
// Static hero headline for LCP: visible on first paint (no opacity 0 / animation delay)
    ...
    <section className="relative h-[80vh] sm:h-screen w-full flex items-center justify-center px-6 pt-20 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-start justify-center h-full">
        <div className="space-y-2 mb-6 md:mb-10">
          <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-[11rem] font-black tracking-tighter leading-[0.85] text-black dark:text-white">
            IBEX
          </h1>
          <h1 className="text-7xl sm:text-7xl md:text-8xl lg:text-[11rem] font-black tracking-tighter leading-[0.85] gradient-text">
            SPORTS
          </h1>
          <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-[11rem] font-black tracking-tighter leading-[0.85] gradient-text">
            COMPLEX
          </h1>
        </div>

        <p className="max-w-xl mb-8 md:mb-12 text-lg sm:text-xl md:text-2xl lg:text-3xl text-zinc-600 dark:text-zinc-300 font-light leading-relaxed">
