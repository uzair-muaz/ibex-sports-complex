...
export const HeroSection = () => {
  return (
    <section className="relative h-screen w-full flex items-center justify-center px-6 pt-20 overflow-hidden">
      <HeroScene />
      
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-start justify-center h-full">
        <div className="space-y-2 mb-10">
          <div className="overflow-hidden">
            <TextReveal className="text-8xl md:text-[11rem] font-black tracking-tighter leading-[0.85] text-black dark:text-white" delay={0.1}>
              IBEX
            </TextReveal>
          </div>
          <div className="overflow-hidden">
        ...
        >
          ...
          <div className="hidden md:flex flex-col text-xs font-mono text-zinc-400 dark:text-zinc-500 uppercase tracking-widest border-l border-zinc-400/30 dark:border-zinc-700 pl-6">
            ...
            <span className="text-white dark:text-white font-bold">06:00 - 23:00</span>
          </div>
        </motion.div>
      </div>
    </section>
