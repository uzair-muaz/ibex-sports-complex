...
export const GetInTouchSection = () => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-white dark:bg-[#050505] border-t border-zinc-200 dark:border-white/5 transition-colors duration-200">
      <div className="max-w-7xl mx-auto">
        <div className="mb-10 sm:mb-12 md:mb-16">
          <TextReveal className="text-[10vw] sm:text-[12vw] leading-[0.8] font-black tracking-tighter gradient-text uppercase">
            Get In Touch
          </TextReveal>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          {/* Map Card */}
          <div className="md:col-span-2 relative h-[300px] sm:h-[400px] md:h-[500px] rounded-2xl sm:rounded-3xl overflow-hidden group">
            <iframe
              src={mapEmbedUrl}
              width="100%"
              height="100%"
            ...
            >
              <span className="text-xs font-semibold text-[#0F172A] dark:text-white flex items-center gap-2">
          ...
          <div className="bg-zinc-100 dark:bg-zinc-900 p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl flex flex-col justify-between hover:shadow-xl transition-shadow border border-zinc-200 dark:border-white/5 group">
            <div>
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#2DD4BF] rounded-full flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
            ...
            <div className="space-y-2 mt-4">
              <a
                ...
                className="text-base sm:text-lg md:text-xl font-mono hover:text-[#2DD4BF] transition-colors block"
              >
                {phoneNumber}
              </a>
              <a
                href={`mailto:${email}`}
                className="text-xs sm:text-sm md:text-base text-zinc-500 hover:text-[#2DD4BF] transition-colors block break-all"
              >
                {email}
              </a>
            </div>
          ...
          <div className="group bg-zinc-900 dark:bg-zinc-900 text-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl flex flex-col justify-between border border-white/10 hover:border-[#2DD4BF]/50 transition-colors">
            <div>
              <div className="mb-4 sm:mb-6">
                <AnimatedClockIcon className="w-6 h-6 sm:w-8 sm:h-8" color="#2DD4BF" />
              </div>
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-2">
                Opening Hours
              </h3>
            </div>
            <ul className="space-y-3 sm:space-y-4 font-mono text-xs sm:text-sm text-zinc-400">
              <li className="flex justify-between border-b border-white/10 pb-2">
                <span>Mon - Fri</span>
                <span className="text-white">12 PM - 2 AM</span>
              </li>
              <li className="flex justify-between border-b border-white/10 pb-2">
                <span>Saturday</span>
                <span className="text-white">12 PM - 2 AM</span>
          ...
          <div className="md:col-span-2 bg-[#2DD4BF] p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-0 text-[#0F172A] relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xs sm:text-sm md:text-base text-[#0F172A]/70 font-medium">
